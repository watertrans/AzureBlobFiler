 ...
 */
export function truncatedISO8061Date(date: Date, withMilliseconds = true): string {
 ...
 * @returns {string}
 */
export function padStart(currentString: string, targetLength: number, padString = ' '): string {
  padString = padString || ' ';
